...
import { collection, doc, getDoc, getDocs, getFirestore, serverTimestamp, Timestamp } from "firebase/firestore";
  ...
  const handleSave = () => {
      const savedData = {
        ...
        if (workoutDesc && nameVal && duration && workoutList.length > 0) {
          ...
          workoutRef.add(savedData).then(() => openSwitchFunction(0)).catch(error => console.log(error));
        } else {
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.container}>
        ...
        <View style={styles.pageHeaderNavs}>
          ...
          <TouchableOpacity style={styles.trackSaveButtonContainer} onPress={() => handleSave()}>
