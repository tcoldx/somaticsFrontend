  ...
  return (
    <View style={styles.container}>
      <SafeAreaView style={styles.columnContainer}>
        ...
        <Image
          style={styles.image}
          source={require("../../assets/payscreen.png")}
        />
        ...
        <View style={[styles.fact, styles.firstFact]}>
          ...
          <Text style={styles.factText}>
            50 dedicated exercises and workouts
          </Text>
        </View>
        ...
        <View style={styles.paymentList}>
          <TouchableWithoutFeedback
            onPress={() => setPaymentDuration("yearly")}
          >
            <View
              style={
                paymentDuration == "yearly"
                  ? [styles.paymentType, styles.selectedPayment]
                  : [styles.paymentType]
              }
            >
              <View
                style={
                  paymentDuration == "yearly"
                    ? [styles.savings, styles.selectedSavings]
                    : [styles.savings]
                }
              >
          ...
          <TouchableWithoutFeedback
            onPress={() => setPaymentDuration("monthly")}
          >
            <View
              style={
        ...
        <View style={styles.terms}>
          ...
          <Text style={[styles.termsText, styles.underline]}>
            Terms & Conditions
          </Text>
        </View>
      </SafeAreaView>
